...
,pivot_cte AS (
    ...
    PIVOT (
        ...
        FOR report_label IN (
            ...
            ,'total_liability_and_shareholder_equity' as total_liability_and_shareholder_equity
...
SELECT
    ...
    ,max(total_liability_and_shareholder_equity) as total_liability_and_shareholder_equity
